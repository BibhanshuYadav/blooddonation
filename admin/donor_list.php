...
<div id="content">
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      // Simplified query to fetch donor details without joining
      ...
      <div class="table-responsive">
        <table class="table table-bordered" style="text-align: center">
          <thead>
            ...
            <th style="text-align: center">Aadhaar_Number</th>
            <th style="text-align: center">Ltitude</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php echo $row['donor_blood']; ?></td> <!-- Display donor_blood directly -->
